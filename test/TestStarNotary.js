...
it('can add the star name and star symbol properly', async() => {
    ...
    let instance = await StarNotary.deployed();
    assert.equal(await instance.name.call(), "Udacity tutorial token");
    assert.equal(await instance.symbol.call(), "UTT");
});
...
it('lets 2 users exchange stars', async() => {
    ...
    assert.equal(await instance.ownerOf.call(starId1), owner);
